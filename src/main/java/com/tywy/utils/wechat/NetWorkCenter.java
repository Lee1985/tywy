...
public class NetWorkCenter {
	...
	private static String doRequest(String method, String url, String paramData, final List<File> fileList) {
		String resultJson = "";
	...
	public static void main(String[] args) {
		String GET_ACCESSTOKEN_URL = "https://api.weixin.qq.com/customservice/kfaccount/add?access_token=XmWtP1qFrj2VUpsnn4b30Cv4te0cC9xxpbFBJ_zqcluJ--w2W3F7ahbjnPhRsnIiBVknTBYuwKtonmFjxmOwoJy7dXvTFR5LbnE7_diIoSNWJfnJLdEX_W9vjYLU-izrQRWeAAAIJO";
		Map<String, String> map = new HashMap<>();
		map.put("kf_account", "test1@test");
		map.put("nickname", "客服");
		map.put("password", "D78AA1B899CBC2D8EA461CF5E4D66C38");
		StringBuilder buffer = new StringBuilder();
		// 根据传进来的参数拼url后缀- -!
		...
		// 去掉最后一个&符号
		String paramData = buffer.substring(0, buffer.length() - 1);
		String result = doPost(GET_ACCESSTOKEN_URL, paramData);
