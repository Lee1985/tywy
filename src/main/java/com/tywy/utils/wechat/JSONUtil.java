...
public final class JSONUtil {
	...
	public static Object getStringFromJSONObject(final String json, final String key) {
		CommonUtils.requireNonNull(json, "json is null");
	...
	public static <T> T toBean(String jsonStr, Class<T> beanClass) {
		CommonUtils.requireNonNull(jsonStr, "jsonStr is null");
	...
	public static <T> String toJson(T obj) {
		CommonUtils.requireNonNull(obj, "obj is null");
	...
	public static String toJson(Map<String, Object> map) {
		CommonUtils.requireNonNull(map, "map is null");
	...
	public static String prettyFormatJson(String jsonString) {
		CommonUtils.requireNonNull(jsonString, "jsonString is null");
