...
public class LoginController extends BaseController{
	...
	@RequestMapping(value="back/login" , method={RequestMethod.GET , RequestMethod.POST})
	...
	@RequestMapping(value="back/main" , method={RequestMethod.GET , RequestMethod.POST})
	public String main(HttpServletRequest request , HttpServletResponse response){
		return "framework/main";
	}
	
	@RequestMapping(value="back/logout" , method={RequestMethod.GET , RequestMethod.POST})
