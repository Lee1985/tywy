	...
	<div id="content" region="center" title="列表" style="padding:5px;">
		...
		">
			<thead>
				<tr>
					<th
						data-options="field:'userId',width:80,align:'center',sortable:true">登陆账号</th>
					<th
						data-options="field:'userName',width:80,align:'center',sortable:true">用户名称</th>
					<th
						data-options="field:'roleId',width:80,align:'center',formatter:formatRole,sortable:true">角色</th>
					<th
						data-options="field:'mobile',width:80,align:'center',sortable:true">手机号码</th>
					<th
						data-options="field:'email',width:80,align:'center',sortable:true">email</th>
					<th
						data-options="field:'description',width:80,align:'center',sortable:true">备注</th>
					<th
						data-options="field:'status',width:80,align:'center',formatter:formatStatus,sortable:true">状态</th>
					<th
						data-options="field:'isDelete',width:80,align:'center',formatter:formatIsDelete,sortable:true,styler:isDeleteStyler">是否删除</th>
				</tr>
			</thead>
		</table>
		<div id="toolbar">
		...
		<div id="dlg" class="easyui-dialog"
			...
			style="width:400px;height:370px;padding:10px 20px" closed="true"
			buttons="#dlg-buttons">
			<div class="ftitle">请完善以下信息！</div>
			<form id="fm" name="fm" method="post"
				action="system/systemUserAjaxSave.do" data-options="novalidate:true">
				<div class="fitem">
				...
				<div class="fitem">
					<label>登陆账号:</label> <input id="userId" name="userId"
						style="width: 200px" class="easyui-textbox"
				...
				<div id="uPassDiv">
					<div class="fitem">
						<label>登陆密码:</label> <input id="userPwd" name="userPwd"
							type="password" style="width: 200px" class="easyui-textbox"
							data-options="required:true,validType:'length[2,32]'">
					</div>
					<div class="fitem">
