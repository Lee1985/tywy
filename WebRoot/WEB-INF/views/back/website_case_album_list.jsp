...
<script type="text/javascript">
	$(function() {
	  ...
	  $('#deleteBtn').click(function(){
		  doDelete('system/websiteCaseAlbumTAjaxDelete.do');
	  });
	  
	  $('#lockOpenBtn').click(function(){
		  doUpdateStatus('system/websiteCaseAlbumTAjaxUpdate.do',1);
	  });
	  
	  $('#lockBtn').click(function(){
		  doUpdateStatus('system/websiteCaseAlbumTAjaxUpdate.do',0);
	  });
	  
	  $('#backBtn').click(function(){
		  location.href = 'system/websiteCaseTList.do';
	  });
	});
...
<body>
	<div style="width:100%;height:100%">
		<table id="dg" class="easyui-datagrid" style="width:100%;height:100%"
			data-options="url:'system/websiteCaseAlbumTAjaxPage.do?caseId=${caseId }', iconCls:'icon-save', 
			...
			<thead>
				<tr>
					<th width="15%" data-options="field:'urlPath',align:'center',sortable:true,formatter:formatImg">图片</th>
					<th width="15%" data-options="field:'serialNumber',align:'center',sortable:true">编号</th>
					<th width="15%" data-options="field:'imageName',align:'center',sortable:true">名称</th>
					<th width="6%"data-options="field:'iconUrl',align:'center',sortable:true,formatter:formatIcon">平面图</th>
					<th width="5%" data-options="field:'status',align:'center',sortable:true,formatter:formatStatus">状态</th>
					<th width="15%" data-options="field:'updateDateStr',align:'center',sortable:true">修改时间</th>
				</tr>
			</thead>
		</table>
		<div id="dlg" class="easyui-dialog"
			...
			<form id="fm" name="fm" method="post" action="system/websiteCaseAlbumTAjaxSave.do">
				<div class="fitem">
				...
				<div class="fitem">
					...
					<input id="imageNameLabel" name="imageName" style="width: 200px" class="easyui-textbox" data-options="required:true,validType:'length[1,15]'"/>
				</div>
				<div class="fitem">
					<label><font color="red">*</font>编号:</label>
					<input id="serialNumberLabel" name="serialNumber" style="width: 200px" class="easyui-textbox" data-options="required:true,validType:'length[1,15]'"/>
				</div>
				<div class="fitem">
					<div style="float: left;margin-top: 25px;"><font color="red">*</font>平面图:</div>			
		...
		<div id="toolbar">
			<a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-back" plain="true" id="backBtn">返回</a>						
	...
	<script type="text/javascript">
	 	  ...
	 	  var iconStream  = singleIconCommonUpload('website_case_album_plan',function(file){
	 		 console.log(file);
	 		 var inputs = '';
		  ...
		  var stream = singleCommonUpload('website_case_album',function(file){
		      var inputs = ''; 
			  for(var prop in file){
				  var value = file[prop];
				  if(prop == 'id'){
