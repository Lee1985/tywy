...
<body>
	<div style="width:100%;height:100%">
		<table id="dg" class="easyui-datagrid" style="width:100%;height:100%"
			...
			<thead>
				<tr>
					<th data-options="field:'urlPath',align:'center',sortable:true,formatter:formatImg" width="20%">导航图片</th>
					<th data-options="field:'caseName',align:'center',sortable:true" style="width: 20%;">案例名称</th>
	...
	<script type="text/javascript">
	var index;		
	  var stream = singleCommonUpload('website_case_nav',function(file){
	      var inputs = ''; 
